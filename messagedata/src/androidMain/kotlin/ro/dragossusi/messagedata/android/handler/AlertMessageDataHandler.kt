...
import ro.dragossusi.messagedata.R
 ...
 * @since 10.06.2020
 */
open class AlertMessageDataHandler(private val alertHandler: AlertHandler) :
  ...
  override fun onUnknownError(throwable: Throwable) {
    throwable.message?.let { alertHandler.showError(it.toMessageData()) }
